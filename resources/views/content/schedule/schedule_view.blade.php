...
<!-- Navbar-->
      ...
      <section class="pt-7 pb-5 d-flex align-items-end dark-overlay bg-cover" style="background-image: url('{{ asset('images/demo_schedule_banner.jpg') }}');">
        <div class="container overlay-content">
          <div class="d-flex justify-content-between align-items-start flex-column flex-lg-row align-items-lg-end">
            <div class="text-white mb-4 mb-lg-0">
              <h1 class="text-shadow verified">{{ $schedule->title }}</h1>
              <p><i class="fa-map-marker-alt fas mr-2"></i> 53 Broadway, Brooklyn, NY 1129</p>
              <p class="mb-0 d-flex align-items-center"><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-primary"></i><i class="fa fa-xs fa-star text-gray-200 mr-4">                   </i></p>
            </div>
          </div>
        </div>
      </section>
                ...
                <div class="text-block">
                    ...
                    @if($schedule->gallery)
                        @foreach($schedule->gallery as $image)
                            <div class="col-lg-4 col-12 px-1 mb-2"><img class="img-fluid myImg" src="{{ asset('images/schedule/' . $image) }}" alt="..."></div>
                        @endforeach
                    @endif
                    </div>
                </div>
